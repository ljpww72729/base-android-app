...
public class DeveloperPresenter implements DeveloperContract.Presenter {
    ...
    @NonNull
    private final DeveloperContract.View mContractView;
    @NonNull
    private final BaseSchedulerProvider mSchedulerProvider;
    @NonNull
    private CompositeSubscription mSubscriptions;

    public DeveloperPresenter(@NonNull String requestTag, @NonNull ServerImp serverImp,
                              @NonNull DeveloperContract.View contractView,
